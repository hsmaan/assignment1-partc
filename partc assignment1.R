...
# Prepare and extract annotation information that will contain genes names to be used later as part
# of the DGEList below.
data(annotEnsembl63)
...
# define genes with high enough expression levels. Here we define it to be genes with more than 1 cpm
# (count per million reads) in at least 20 samples
